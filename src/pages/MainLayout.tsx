  ...
  return (
    <Wrapper>
      <Body className="body" style={{ minHeight: "calc(100vh)" }}>
        ...
        <Sider width={stepCompWidth} className="steps">
          <PerfectScrollbar>
        ...
        <Sider
          ...
          className={!financialTableVisible ? "hidden" : "" + " finance"}
          style={{ borderLeft: "2px solid #f2f2f2" }}
        >
          <>
            <Row>
              <Col span={12}>
                ...
                button={
                  <Col span={10}>
                    <Button
                      ...
                      disabled={mobiusUpdated ? true : currentStep.mainStep === 0 ? true : false}
                    />
